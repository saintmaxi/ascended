...
const vxAddress = "0xA24faF282be68837dDEb285933465118E96567ad";
const vxAbi = () => {
...
const looksrareLink = "https://looksrare.org/collections/0xA24faF282be68837dDEb285933465118E96567ad";
...
function init() {
    ...
    if (gamestopProvider) {
        if (window.ethereum?.isGamestop) {
            ...
            injectedMsg = "Connect with the default provider in your browser";
        }
    }
    else {
        injectedName = "Injected";
